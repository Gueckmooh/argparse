...
type arg struct {
	...
	posstring bool        // Posstring is set if arg is to contain unparsed CLI strings
...
func (o *arg) assignPosString(args *[]string) {
	...
	*o.result.(*PosStringResult) = result
}
